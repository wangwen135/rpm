...
public class RegisterHandlerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RegisterHandlerInitializer.class);

    private RegisterConnection registerConnection;

    public RegisterHandlerInitializer(RegisterConnection registerConnection) {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        ClientConfig config = registerConnection.getClientConfig();
        ...
        // 客户端注册
        pipeline.addLast(new RegistHandler(registerConnection));
